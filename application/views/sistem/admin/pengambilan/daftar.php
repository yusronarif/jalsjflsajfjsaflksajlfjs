            ...
            if (isset($errors) && $errors <> 1) {
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h6 class="panel-title"><i class="icon-user"></i> Detail Member</h6>
                            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading"><h6 class="panel-title"><i class="icon-food"></i> Detail Pesanan
                                </h6></div>
                            <?php foreach ($pesanan as $pesan): ?>
                                ...
                                <div class="panel-body">
                                    <div align="center">
                                        <strong><?php echo $pesan->NO_TRANSAKSI; ?> ~ <?php echo hari(date("w", strtotime($pesan->UNTUK_TRANSAKSI))) . ", " . date("d-m-Y", strtotime($pesan->UNTUK_TRANSAKSI)); ?></strong>
                                    </div>
                                    <br>
