		...
		<ul class="nav navbar-nav navbar-right collapse" id="navbar-icons">
			<li class="user dropdown">
				...
				<ul class="dropdown-menu dropdown-menu-right icons-right">
					<li><a href="<?php echo site_url($kontrol.'/profil')?>"><i class="icon-user"></i> Profile</a></li>
					<li><a href="<?php echo site_url($kontrol.'/ganti_password')?>"><i class="icon-cog"></i> Ganti Password</a></li>
	...
	<!-- Sidebar -->
		<div class="sidebar">
			<div class="sidebar-content">
				...
				<!-- Main navigation -->
				<ul class="navigation">
					<li <?php if($this->uri->rsegment(1)=='dashboard' OR $this->uri->rsegment(1)==''){echo 'class="active"';}?>><?php echo anchor($kontrol.'/dashboard', '<span>Dashboard</span> <i class="icon-screen2"></i>')?></li>
					<?php foreach ($mainmenu as $main_menu) :?>
						<?php if($main_menu->LINK_MM==NULL && $main_menu->SEGMENT_MM==NULL){?>
							<li>
        						<a href="javascript:void(0)"><span><?php echo $main_menu->NAMA_MM;?></span> <i class="<?php echo $main_menu->ICON_MM;?>"></i></a>
        						<ul>
        						<?php 
        						...
        						?>
        							<li <?php if($this->uri->rsegment(1)==$main_menu_child->SEGMENT_MM){echo 'class="active"';}?>><?php echo anchor($kontrol.'/'.$main_menu_child->LINK_MM, $main_menu_child->NAMA_MM)?></li>
        						<?php }?>
        						</ul>
        					</li>
						<?php } else {?>
							<li <?php if($this->uri->rsegment(1)==$main_menu->SEGMENT_MM){echo 'class="active"';}?>><?php echo anchor($kontrol.'/'.$main_menu->LINK_MM, '<span>'.$main_menu->NAMA_MM.'</span> <i class="'.$main_menu->ICON_MM.'"></i>')?></li>
						<?php }?>
					<?php endforeach;?>
			...
			<div class="breadcrumb-line">
				...
				<ul class="breadcrumb-buttons collapse">
					...
					<li class="language dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-cogs"></i> <span>Aksi</span> <b class="caret"></b></a>
						<ul class="dropdown-menu dropdown-menu-right icons-right">
							<li <?php if($this->uri->rsegment(2)=='edit'){echo 'class="active"';}?>><?php echo anchor('admin/'.$this->uri->rsegment(1).'/edit', '<i class="icon-plus"></i> Tambah')?></li>
						</ul>
					</li>
				</ul>
				<?php }?>
