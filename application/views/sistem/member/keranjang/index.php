    ...
    <div class="table-responsive">
        ...
        <table class="table table-responsive">
            ...
            <?php foreach ($this->cart->contents() as $items): ?>
                <?php foreach ($items['put_when'] as $put_id => $put_val): ?>
                    <tr>
                        ...
                        <td class="text-center"><?php echo $put_id;?></td>
                        ...
                        <td>
                            <a href="<?php echo site_url('member/keranjang/validate_delete_cart/' . $items['rowid']. '::'. $put_id) ?>" class="btn btn-danger btn-icon btn-xs tip" title="Hapus" onclick="return confirm('Yakin akan menghapus?')"><i class="icon-remove"></i></a>
                            <?php
            ...
            <tr>
                <td colspan="6" class="text-right"><strong>Saldo Anda</strong></td>
                <td class="text-right"><strong><?php echo number_format($saldo_user); ?></strong></td>
                <td></td>
            </tr>
            <tr>
                <td colspan="6" class="text-right"><strong>Sisa Saldo</strong></td>
